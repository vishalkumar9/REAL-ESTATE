    ...
    if (mode) {
      try {
        ...
        const response = await fetch(
          `${process.env.REACT_APP_BACKEND_USER_URL}/login`,
          {
            method: 'POST',
            body: formData,
          },
      ...
      try {
        ...
        const response = await fetch(
          `${process.env.REACT_APP_BACKEND_USER_URL}/signup`,
          {
            method: 'POST',
            body: formData,
          },
      ...
      <div className="userAuth-div">
        <div className="userAuth-main-div">
          ...
          <div className="userAuth-input-div">
            ...
            {!mode && displayImage && (
              <Avatar src={displayImage[0]} id="user_profile_image" />
            )}
        ...
        <div className="userAuth-mode-div">
          {mode && (
            <button className="signUp" onClick={handleModeChangeClick}>
              Sing Up
            </button>
          )}
          {!mode && (
            <button className="logIn" onClick={handleModeChangeClick}>
              Log In
            </button>
          )}
        </div>
