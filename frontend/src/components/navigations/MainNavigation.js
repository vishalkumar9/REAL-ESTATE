  ...
  return (
    <nav className="navbar bg-body-tertiary fixed-top custom_theme_navbar">
      <div className="container-fluid">
        ...
        <button
          className="navbar-toggler custom_theme_navbar_btn"
          type="button"
        ...
        <div
          className="offcanvas offcanvas-end custom_theme_navbar"
          tabIndex="-1"
          id="offcanvasNavbar"
        ...
        >
          <div className="offcanvas-header">
            ...
            <button
              type="button"
              className="btn-close custom_theme_navbar_btn"
          ...
          <div className="offcanvas-body">
            <ul className="navbar-nav justify-content-end flex-grow-1 pe-3">
              {props.routes.map((routeDetails) => (
                <li
                  className={`nav-item ${
                    routeDetails.content === 'Profile' ? 'dropdown' : ''
                  }`}
                  key={routeDetails.content}
                >
                        ...
                        {routeDetails.subContent.map((subRouteDetails) => (
                          <li key={subRouteDetails.content}>
                            <a
                              ...
                              href={subRouteDetails.url}
                            >
                              {subRouteDetails.content}
                            </a>
                          </li>
                        ))}
                      </ul>
