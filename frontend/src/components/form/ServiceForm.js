            ...
            <form onSubmit={handleServiceRequest} className="uploadForm_div">
                ...
                <div className="form_input_div">
                    ...
                    <div className="option">
                        ...
                        {errors.serviceDetailError && <span style={{color:"red"}} className="error">{errors.serviceDetailError}</span>}
                    </div>
                </div>
                <div className="form_input_div">
                    <span style={{color:"red", fontSize:"large"}}>*</span>
                    ...
                    <div className="option">
                        ...
                        {errors.addressError && <span style={{"color":"red"}} className="error">{errors.addressError}</span>}
                    </div>
                </div>
                <div className="form_input_div">
                    <span style={{color:"red", fontSize:"large"}}>*</span>
                    ...
                    <div className="option">
                        ...
                        {errors.phnoError && <span style={{"color":"red"}} className="error">{errors.phnoError}</span>}
                    </div>
                </div>
