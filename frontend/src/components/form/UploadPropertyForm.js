      ...
      <form className="uploadForm_div">
          ...
          <div className="option">
            {arrPropertyType.map((value) => (
              <button
                name="propertyType"
                value={value}
                className={value === propertyData.propertyType ? 'active' : ''}
            ...
            {arrPurpose.map((value) =>
              ...
              propertyData.propertyType === 'Residential' ? (
                <button
                  name="purposeType"
                  value={value}
                  className={value === propertyData.purposeType ? 'active' : ''}
                  onClick={handleChange}
                >
                  {value}
                </button>
                ...
                propertyData.propertyType === 'Commercial' && (
                  <button
                    ...
                    value={value}
                    className={
                      value === propertyData.purposeType ? 'active' : ''
                    }
                    onClick={handleChange}
                  >
                    {value}
              ...
              ? arrResidentialType.map((value) =>
                  ...
                  propertyData.purposeType === 'Sell' ? (
                    <button
                      name="type"
                      value={value}
                      className={value === propertyData.type ? 'active' : ''}
                      onClick={handleChange}
                    >
                      {value}
                    </button>
              ...
              <div className="option">
                {arrBhk.map((value) => (
                  <button
                    name="bhk"
                    value={value}
                    className={value === propertyData.bhk ? 'active' : ''}
                    onClick={handleChange}
                  >
                    {value}
                  </button>
            ...
            <div className="form_input_div">
              ...
              <div className="option">
                {arrBathroom.map((value) => (
                  <button
                    name="countOfBathroom"
                    value={value}
                    className={
                      value === propertyData.countOfBathroom ? 'active' : ''
                    }
                    onClick={handleChange}
                  >
                    {value}
            ...
            <div className="option">
              {arrConstructionStatus.map((value) => (
                <button
                  ...
                  value={value}
                  className={
                    value === propertyData.constructionStatus ? 'active' : ''
                  }
                  onClick={handleChange}
                >
                  {value}
            ...
            <div className="option">
              {arrFurnishType.map((value) => (
                <button
                  name="furnishType"
                  value={value}
                  className={value === propertyData.furnishType ? 'active' : ''}
                  onClick={handleChange}
                >
                  {value}
                </button>
        ...
        </div>
        {
          <div className={error ? 'blockButton' : 'submitButton'}>
            <button disabled={error} onClick={!error && uploadProperty}>
              Submit
            </button>
          </div>
        }
